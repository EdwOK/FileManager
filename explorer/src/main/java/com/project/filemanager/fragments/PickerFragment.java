...
public final class PickerFragment extends BaseBrowserFragment {
    ...
    public void listItemAction(File file) {
        final Uri pickedUri = FileProvider.getUriForFile(getActivity(), "com.project.filemanager.fileprovider", file);
