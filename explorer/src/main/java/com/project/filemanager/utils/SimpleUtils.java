...
import com.project.filemanager.previews.IconTypes;
...
public class SimpleUtils {
    ...
    public static boolean createFile(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                return document.createFile(IconTypes.getMimeType(file), file.getName()) != null;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
            }
    ...
    public static void openFile(final Context context, final File target) {
        final String mime = IconTypes.getMimeType(target);
