package com.project.filemanager.controllers;
...
import com.project.filemanager.activities.ExplorerActivity;
import com.project.filemanager.R;
import com.project.filemanager.activities.SearchActivity;
import com.project.filemanager.dialogs.DeleteFilesDialog;
import com.project.filemanager.dialogs.FilePropertiesDialog;
import com.project.filemanager.dialogs.GroupOwnerDialog;
import com.project.filemanager.dialogs.RenameDialog;
import com.project.filemanager.dialogs.ZipFilesDialog;
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.actiongroupowner:
                    for (int i = 0; i < checkedItemSize; i++) {
                        ...
                        if (items.get(key)) {
                            ...
                            mode.finish();
                            dialog9.show(mActivity.getFragmentManager(), ExplorerActivity.TAG_DIALOG);
                            break;
                        }
                    }
                    return true;
                case R.id.actiondelete:
                    ...
                    mode.finish();
                    dialog1.show(mActivity.getFragmentManager(), ExplorerActivity.TAG_DIALOG);
                    return true;
                ...
                case R.id.actionzip:
                    ...
                    mode.finish();
                    dialog.show(mActivity.getFragmentManager(), ExplorerActivity.TAG_DIALOG);
                    return true;
                case R.id.actionrename:
                    for (int i = 0; i < checkedItemSize; i++) {
                        ...
                        if (items.get(key)) {
                            ...
                            mode.finish();
                            dialog3.show(mActivity.getFragmentManager(), ExplorerActivity.TAG_DIALOG);
                            break;
                        }
                    }
                    return true;
