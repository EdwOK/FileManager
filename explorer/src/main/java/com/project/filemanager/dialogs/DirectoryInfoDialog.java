...
import com.project.filemanager.utils.Permissions;
import com.project.filemanager.utils.SimpleUtils;
import com.project.filemanager.utils.StatisticFileSystem;
...
public final class DirectoryInfoDialog extends DialogFragment {
    ...
    public void onStart() {
        super.onStart();
        File mFile = new File(ExplorerTabsAdapter.getCurrentBrowserFragment().mCurrentPath);
    ...
    private static final class PartitionInfoTask extends
        ...
        protected PartitionInfo doInBackground(final File... params) {
            ...
            final StatisticFileSystem statFs = new StatisticFileSystem(path);
